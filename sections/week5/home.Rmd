...
xxx <- as.list(desc)
saveRDS(xxx, here::here(dataDir, "ess_variable_descriptions.rds"))
```

Kestilä (2006) used principal components analysis to estimate the measurement model underlying thirteen ESS variables
related to *Trust in Politics*. Based on the results of this PCA, Kestilä recommended the following three-factor
structure.
